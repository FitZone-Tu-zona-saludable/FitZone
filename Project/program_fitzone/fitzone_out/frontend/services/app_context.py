...
accounting_service = AccountingService()   # debe instanciarse antes de payment_service

payment_service = PaymentService(
    auth_service=auth_service,
    membership_service=membership_service,
    accounting_service=accounting_service,  # inyección para registro automático
)
...
class _UserControllerAdapter:
    def login_user(self, email, password):
        ...
        if result:
            return {"success": True, "data": set_current_user(result)}
